...
Camera3D createEditorCamera() {
  return Camera3D(Vector3(0, 10, 10),  // position
...
void updateEditorCamera(ref Camera3D cam, Rectangle r) {
  ...
  if (shift) {
    // pan: translate position + target in camera-local XY plane
    ...
    // orbit: rotate position around target via spherical coords
